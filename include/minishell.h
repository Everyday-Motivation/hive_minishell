...
readline        // Shows a prompt and lets the user edit a line; returns the typed string.
rl_clear_history// Wipes the saved input history from memory.
rl_on_new_line  // Tells Readline you’re starting a fresh line (after printing stuff).
